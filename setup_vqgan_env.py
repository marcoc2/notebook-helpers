...
#Imports from the Super Resolution method

#https://colab.research.google.com/github/tensorflow/hub/blob/master/examples/colab/image_enhancing.ipynb#scrollTo=ABjkkJHC2jNL
...
#Prepare slomo
#ref: https://colab.research.google.com/github/tugstugi/dl-colab-notebooks/blob/master/notebooks/SuperSloMo.ipynb#scrollTo=fZwM0GtmA7mX
